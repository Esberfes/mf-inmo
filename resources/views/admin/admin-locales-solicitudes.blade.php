            ...
            <table class="admin-table table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="text-center cursor-pointer data-coment-wrapper">
                                <i class="fab fa-readme"></i>
                                <div class="d-none data-comment">{{ $solicitud->comentario }}</div>
                            </div>
                        </td>
                        <td>
...
@section('scripts')
<script>
    let wrappers = $(".data-coment-wrapper");
    wrappers.each(function(i){
        let currentWrapper = $(wrappers.get(i));
        let dataContainer = currentWrapper.find(".data-comment");
        currentWrapper.popover({
            container:	currentWrapper.parent(),
            content: dataContainer.text(),
            trigger: 'hover',
        })
    });
</script>
