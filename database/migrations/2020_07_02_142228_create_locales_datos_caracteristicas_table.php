...
class CreateLocalesDatosCaracteristicasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('locales_datos_caracteristicas', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('locales_datos_caracteristicas');
    }
}
