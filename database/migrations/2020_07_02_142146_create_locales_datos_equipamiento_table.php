...
class CreateLocalesDatosEquipamientoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('locales_datos_equipamiento', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('locales_datos_equipamiento');
    }
}
